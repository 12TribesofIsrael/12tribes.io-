...
(function($){
  "use strict";
	...
	$(document).ready(function(){
		...
		// 	$('.neoh_fn_main').css('opacity', '1');

		// },1000);

		$(".header").load("header-footer/header.html"); 
		$(".footer").load("header-footer/footer.html"); 
		$(".header-inner").load("../header-footer/header.html"); 
		$(".footer-inner").load("../header-footer/footer.html"); 
		...
		setTimeout(function(){
			...
			$('#mobile-hamburger').on( "click", function() { 
				// $('#myNav').attr('style', 'width:100%;');
				$('#myNav').addClass('navWidth');
			})

			$('a.closebtn').on( "click", function() { 
				// $('#myNav').attr('style', 'width:0%;');
				$('#myNav').removeClass('navWidth');
			})

			$('span.mobile-caret').on( "click", function() { 
				// $('#myNav').attr('style', 'width:0%;');
				$('#myNav').toggleClass('openMobileSub');
			})
		...
		setTimeout(function(){
			...
			function detect_visibility() {
				...
				var element = document.getElementById("prophecy-video");
		...
		if ($("body").hasClass("home")) { 
			...
			if (width <= 2560 && width > 1440) { // 2560 less
				new Swiper('.swiper', {
					loop: false,
					navigation: {
			...
			} else if (width <= 1440 && width > 580) { // if 1440 less
				new Swiper('.swiper', {
					loop: false,
					navigation: {
						nextEl: '.swiper-button-next',
		...
		if (width <= 2560 && width > 1440) { // 2560 less
			...
			new Swiper('.swiper-carousel-two', {
				loop: true,
				slidesPerView: 7,
				spaceBetween: 10,
				autoplay: {
		...
		$('#bullets #first').on( "click", function() { 
			$('.map-image-one').attr('style', 'display:block;');
			$('.map-image-two').attr('style', 'display:none;');
		})

		$('#bullets #second').on( "click", function() { 
			$('.map-image-one').attr('style', 'display:none;');
			$('.map-image-two').attr('style', 'display:block;');
		})
